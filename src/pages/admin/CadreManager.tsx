...
import { 
  ...
  CheckCircle2, ArrowLeft, LayoutDashboard, Globe, MapPin, Calendar
} from "lucide-react";
...
export const CadreManager = () => {
  ...
  // Form State - Default khidmah disetel ke 2025 - 2028
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (editingId) {
      ...
      if (!error) {
        ...
        // DI SINI KITA TAMPILKAN EROR ASLINYA BIAR KETAHUAN MASALAHNYA
